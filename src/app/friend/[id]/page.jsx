  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-xl text-gray-500 animate-pulse">Loading friend details...</div>
      </div>
    );
  }
        ...
        <div className="md:w-1/3 shrink-0">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col items-center text-center gap-4">
            ...
            <div className="flex flex-col items-center gap-1.5">
                <span className={`px-4 py-0.5 text-xs font-semibold rounded-full ${mainStatus.bg} ${mainStatus.text}`}>
                    {friend.status.toUpperCase()}
                </span>
                
                {friend.tags?.includes("Family") && (
                    <span className={`px-4 py-0.5 text-xs font-semibold rounded-full ${familyTag.bg} ${familyTag.text}`}>
                        FAMILY
                    </span>
                )}
            </div>
        ...
        <div className="grow flex flex-col gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-between gap-4">
            <div className="flex flex-col gap-1">
                <h3 className="text-lg font-semibold text-teal-800">Relationship Goal</h3>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col gap-6">
            <h3 className="text-lg font-semibold text-teal-800">Quick Check-In</h3>
